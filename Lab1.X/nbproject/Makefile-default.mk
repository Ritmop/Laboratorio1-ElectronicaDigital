...
SOURCEFILES_QUOTED_IF_SPACED=Lab1.c iocb_init.c ADC_lib.c disp_7seg.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Lab1.p1 ${OBJECTDIR}/iocb_init.p1 ${OBJECTDIR}/ADC_lib.p1 ${OBJECTDIR}/disp_7seg.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/Lab1.p1.d ${OBJECTDIR}/iocb_init.p1.d ${OBJECTDIR}/ADC_lib.p1.d ${OBJECTDIR}/disp_7seg.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Lab1.p1 ${OBJECTDIR}/iocb_init.p1 ${OBJECTDIR}/ADC_lib.p1 ${OBJECTDIR}/disp_7seg.p1

# Source Files
SOURCEFILES=Lab1.c iocb_init.c ADC_lib.c disp_7seg.c
...
${OBJECTDIR}/disp_7seg.p1: disp_7seg.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -mno-default-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/disp_7seg.p1 disp_7seg.c 
